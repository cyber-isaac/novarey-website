            ...
            <div className="relative">
                ...
                >
                    <h1 className="hero-title text-white">
                        ...
                        <span className="block bg-gradient-to-r from-white to-neutral-500 bg-clip-text text-transparent">Built to be remembered.</span>
                    </h1>
                </motion.div>
                ...
                <motion.p
                    ...
                    className="hero-copy mx-auto mt-16 max-w-xl text-center text-neutral-400 font-medium"
                >
                    A cinematic archive for brand systems, motion studies, web builds, and AI-assisted creative direction.
                </motion.p>
