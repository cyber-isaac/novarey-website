    ...
    return (
        ...
        >
            ...
            <div className="absolute top-1/4 left-0 w-full text-center z-10 pointer-events-none -translate-y-1/2 px-4">
                <h1 className="hero-title-compact text-white mb-4 drop-shadow-2xl">NovaRey</h1>
                <p className="hero-kicker text-slate-200 font-light">Design systems / AI workflows / web builds</p>
            </div>
