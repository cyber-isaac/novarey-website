        ...
        <div className="py-24 relative overflow-hidden">
            <div className="sm:px-6 lg:px-8 max-w-7xl mx-auto px-4">
                <div className="text-center mb-16">
                    ...
                    >
                        Fusing the precision of the Adobe Suite with the speed of AI tools like Cursor, ChatGPT, and Antigravity. I synchronize these systems to engineer design, applications, and workflows with clear creative precision.
                    </motion.p>
                </div>
