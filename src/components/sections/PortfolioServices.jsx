...
const FEATURES = [
    ...
    { icon: Check, title: 'Proven Delivery', sub: 'Clean, reliable results' }
];
        ...
        <section className="py-16 md:py-20 relative overflow-hidden">
            <div className="max-w-7xl mx-auto px-8 relative">
                <div className="text-center mb-12">
                    <div className="text-[10px] font-mono text-orange-500/60 mb-4 tracking-[0.5em] uppercase">Creative capabilities // Service matrix</div>
                    ...
                    <p className="text-slate-400 max-w-2xl mx-auto mt-6">
                        Focused design, web, and AI systems that help the portfolio move from first impression to clear next step.
                    </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
                    {SERVICES.map((service, i) => (
                        <div key={i} className="group relative min-h-[300px] p-6 rounded-2xl bg-white/[0.03] border border-white/10 hover:border-white/20 transition-colors overflow-hidden">
