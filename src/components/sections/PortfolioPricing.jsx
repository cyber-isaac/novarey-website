...
const PLANS = [
    ...
    },
    {
        name: 'Enterprise',
        price: 'Custom',
        desc: 'Bespoke studio systems',
        features: ['Unlimited pages', 'Custom features', 'Dedicated project team', 'Flexible timeline', 'API integrations', 'Priority support'],
        featured: false
    }
];
        ...
        <section className="py-32 relative">
            <div className="max-w-7xl mx-auto px-8">
                <div className="text-center mb-20">
                    <h2 className="text-4xl md:text-5xl font-black text-white italic tracking-tighter uppercase mb-4">Studio Pricing</h2>
                    <p className="text-slate-400 max-w-2xl mx-auto">Transparent investment levels for clean creative delivery. No hidden variables.</p>
                </div>
...
const FAQS = [
    { q: "What's the typical project timeline?", a: "Project timelines vary by scope. A typical landing page takes 1-2 weeks, while a full web or AI system can take 4-8 weeks." },
    { q: "Do you offer post-launch support?", a: "Yes. Projects include 30 days of standard maintenance. Extended support contracts are available." },
    { q: "Can you handle complex API integrations?", a: "Yes. I connect modern design with robust backend systems, AI workflows, and third-party data integrations." }
];
        ...
        <section className="py-32 bg-gradient-to-b from-transparent to-[#0A090F]/50">
            <div className="max-w-3xl mx-auto px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl font-black text-white italic tracking-tighter uppercase mb-2">Project Notes</h2>
