...
const STUDIO_SERVICES = [
    ...
    },
    {
        ...
        icon: PenTool,
        accent: 'rose',
        media: 'https://images.unsplash.com/photo-1561070791-2526d30994b5?q=80&w=1400&auto=format&fit=crop',
    ...
    },
    {
        ...
        icon: Megaphone,
        accent: 'amber',
        media: 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?q=80&w=1400&auto=format&fit=crop',
    ...
    },
    {
        ...
        icon: Cpu,
        accent: 'emerald',
        media: 'https://images.unsplash.com/photo-1677442136019-21780ecad995?q=80&w=1400&auto=format&fit=crop',
        ...
        <section className="relative py-24 px-6 md:px-12 overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                <div className="mt-20 flex flex-wrap justify-center gap-8 md:gap-16 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all duration-700">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/e/e0/Google_Logo_Green.svg" alt="Google" loading="lazy" decoding="async" className="h-6 opacity-30 invert" />
                    <img src="https://upload.wikimedia.org/wikipedia/commons/4/4d/OpenAI_Logo.svg" alt="OpenAI" loading="lazy" decoding="async" className="h-6 invert" />
                    <img src="https://upload.wikimedia.org/wikipedia/commons/a/af/Adobe_Photoshop_CC_icon.svg" alt="Adobe Photoshop" loading="lazy" decoding="async" className="h-6" />
                </div>
            </div>
        </section>
    );
